...
def bind_nsml(model, tokenizer=None, args=None, valid_data=None):
    def save(path, **kwargs):
        nsml.load(checkpoint='model_21', session='KR95329/airush2021-2-4/246')
...
def main():
    ...
    if args.mode == "train":
        ...
        bind_nsml(model, tokenizer, args, valid_data)
        nsml.save('best')
